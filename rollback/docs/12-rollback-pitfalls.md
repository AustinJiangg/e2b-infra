...
不对时间做任何假设。详见[第 17 篇](17-observability-and-verification.md)。

> 反过来，时间倒退也是一个**有用的证据**：950 的验收里，
> 心跳进程在三代之间保持**同一个 PID 和同一个启动时刻** ——
> 这证明了打快照没有重启虚机。见[第 17 篇](17-observability-and-verification.md)。
